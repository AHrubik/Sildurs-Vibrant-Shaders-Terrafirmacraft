...
const float shadowDistance = 128.0f;
	#define SHADOW_DARKNESS 1.65				//shadow darkness levels, lower values mean darker shadows, see .vsh for colors /0.25 is default
...
#define GODRAYS
		...
		const int NUM_SAMPLES = 10;				//increase this for better quality at the cost of performance /5 is default
